...
vi.mock("../../context/AuthContext", () => ({
  useAuthValue: vi.fn(() => ({
    user: { uid: "mockedUid", displayName: "mockedUser" },
  })),
}));
...
describe("EditPost component", () => {
  it("renders component correctly", async () => {
    ...
    expect(
      screen.getByText("Altere os dados da publicação como desejar")
    ).toBeTruthy();
    ...
    expect(screen.getByLabelText("URL da imagem").value).toBe(
    ...
    expect(getByLabelText("URL da imagem").value).toBe(
      "https://example.com/image.jpg"
    );
  ...
  it("submits form with valid data", async () => {
    ...
    fireEvent.change(getByLabelText("Titulo"), {
      target: { value: "Updated Test Post" },
    });
